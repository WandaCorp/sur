...
var RadialBar = /*#__PURE__*/ function(_PureComponent) {
	function RadialBar() {
		var _this;
		_classCallCheck$11(this, RadialBar);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$9(this, RadialBar, [].concat(args));
	...
	_inherits$9(RadialBar, _PureComponent);
	return _createClass$11(RadialBar, [
		{
			key: "getDeltaAngle",
...
//#endregion
export { CartesianGrid as a, PolarAngleAxis as c, XAxis as i, ResponsiveContainer as l, BarChart as n, Bar as o, YAxis as r, RadialBar as s, RadialBarChart as t, Tooltip as u };
